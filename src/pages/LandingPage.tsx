  ...
  return (
    <div className="bg-[#F0F2F5] text-[#4B5563] font-sans relative overflow-hidden flex-1" id="landing-page">
      ...
      <motion.div 
        ...
        className="absolute top-[10%] left-[-10%] md:left-[5%] w-[350px] h-[350px] opacity-10 pointer-events-none"
      >
      ...
      <motion.div 
        ...
        className="absolute top-[5%] right-[-10%] md:right-[2%] w-[450px] h-[450px] opacity-[0.08] pointer-events-none"
      >
        <svg viewBox="0 0 100 100" fill="none" className="w-full h-full text-[#F97316]">
      ...
      >
        <div className="max-w-5xl mx-auto text-center flex flex-col items-center">
          ...
          <motion.h1 variants={fadeInUp} className="text-4xl sm:text-6xl md:text-7xl font-[900] tracking-[-0.05em] leading-[0.95] text-[#111827] uppercase max-w-4xl">
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-12 w-full sm:w-auto">
            <Link to="/register" className="w-full sm:w-auto text-center text-xs font-[900] text-white bg-[#F97316] hover:bg-[#ea6305] px-10 py-4 rounded-full transition-all uppercase tracking-widest shadow-[6px_6px_15px_rgba(249,115,22,0.35),-6px_-6px_15px_#FFFFFF] hover:translate-y-[-2px]">
              Create Your Account
            </Link>
            <Link to="/login" className="w-full sm:w-auto text-center text-xs font-[900] text-[#111827] bg-[#F0F2F5] px-10 py-4 rounded-full transition-all uppercase tracking-widest shadow-[inset_4px_4px_8px_#D1D9E6,inset_-4px_-4px_8px_#FFFFFF] hover:text-[#F97316] hover:translate-y-[-2px]">
      ...
      <motion.section 
        ...
        className="py-20 bg-gradient-to-b from-transparent to-[#EBF0F6]/40 px-4 sm:px-6 lg:px-8 relative z-10"
      >
      ...
      <motion.section 
        ...
        className="py-24 bg-gradient-to-b from-[#EBF0F6]/20 to-[#F0F2F5] border-t border-[#D1D9E6]/30 px-4 sm:px-6 lg:px-8 relative z-10"
      >
        <div className="max-w-7xl mx-auto space-y-24">
          
          <motion.div variants={fadeInUp} className="text-center">
            <span className="text-[#0D9488] text-xs font-black uppercase tracking-widest block">PLATFORM REVELATIONS</span>
            <h2 className="text-2xl sm:text-3xl font-[900] tracking-[-0.04em] text-[#111827] mt-1 uppercase">System Feature Breakdown</h2>
          ...
          <div className="space-y-20">
            ...
            <motion.div variants={fadeInUp} className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-5 space-y-6">
                ...
                <h3 className="text-2xl font-[900] text-[#111827] uppercase tracking-tight">Omnichannel Multilingual Ingestion</h3>
              ...
              <div className="lg:col-span-7 bg-[#F0F2F5] p-6 rounded-4xl shadow-[8px_8px_16px_#D1D9E6,-8px_-8px_16px_#FFFFFF] border border-white/60 hover:shadow-[12px_12px_24px_#D1D9E6,-12px_-12px_24px_#FFFFFF] transition-shadow">
                <div className="bg-white rounded-2xl p-6 border border-[#D1D9E6]/30 space-y-6">
                  ...
                  <div className="bg-[#F0F2F5] p-4 rounded-xl shadow-[inset_4px_4px_8px_#D1D9E6,inset_-4px_-4px_8px_#FFFFFF] relative min-h-[5rem] flex items-center justify-center text-center">
                    {ingestionState === 'recording' && (
            ...
            <motion.div variants={fadeInUp} className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5 space-y-6 lg:order-2 order-1">
                ...
                <h3 className="text-2xl font-[900] text-[#111827] uppercase tracking-tight">Geospatial Data Fusion Engine</h3>
            ...
            <motion.div variants={fadeInUp} className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-5 space-y-6">
                ...
                <h3 className="text-2xl font-[900] text-[#111827] uppercase tracking-tight">One-Click Funding Blueprints</h3>
      ...
      <motion.footer 
        ...
        className="bg-gradient-to-t from-[#E2E8F0] to-[#F0F2F5] border-t border-[#D1D9E6] pt-24 pb-12 px-4 sm:px-6 lg:px-8 relative z-10"
      >
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="bg-[#F0F2F5] p-10 rounded-[40px] shadow-[12px_12px_24px_#D1D9E6,-12px_-12px_24px_#FFFFFF] border border-white/80 space-y-8 text-center flex flex-col items-center">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl sm:text-4xl font-[900] tracking-[-0.04em] text-[#111827] uppercase leading-tight max-w-4xl">ALIGNING VISION, TALENT, AND EXECUTION.</h2>
            </div>
          ...
          <div className="border-t border-[#D1D9E6] pt-8 flex flex-col md:flex-row items-center justify-between text-xs font-bold text-[#4B5563]">
            ...
            <p className="uppercase tracking-[0.15em] text-center md:text-right font-[900] text-[#111827] mt-4 md:mt-0">A PROJECT BY TEAM TEESMAARKHACODERS</p>
          </div>
        </div>
      </motion.footer>
    </div>
